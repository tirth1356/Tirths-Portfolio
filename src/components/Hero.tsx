        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/30 text-primary mb-6 backdrop-blur-md shadow-lg shadow-primary/10"
            >
              ...
              <span className="text-sm font-semibold tracking-wide">
                Open to Work: SWE Intern | SDE | AIML Intern | DevOps Intern | Business Analys
              </span>
            </motion.div>
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <a
                href="https://drive.google.com/file/d/1RqQm8UAR7-mGNVFzc0vS513GxKPkwzUv/view?usp=sharing"
                target="_blank"
